        ...
        <div className='flex gap-2 justify-center flex-col items-center'>        
          ...
          <div className='w-full pr-3'>
            <form onSubmit={() => {
              ...
              className='bg-[#eee] font-mono ml-1.5  w-full px-10 py-3 my-2 text-lg rounded-lg'
              type="number" maxLength={4} placeholder='Enter OTP' />
              <Link to='../captain-riding' onClick={() => {
                  props.setConfirmRidePopupPanel(false)
              }} className='w-full flex justify-center m-1.5 rounded-lg bg-green-600 py-3 text-white text-lg font-semibold'>Confirm</Link>
              <button onClick={() => {
                  props.setConfirmRidePopupPanel(false)
