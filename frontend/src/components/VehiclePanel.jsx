      ...
      className='w-full text-center absolute top-0 font-semibold text-2xl p-1'>
        ...
        <div onClick={() => {
          ...
          <div className='w-1/2 p-2'>
            ...
            <p className='font-medium text-sm text-gray-700'>Premium, sedan rides</p>
          </div>
          <h2 className='text-2xl font-semibold mr-6'>₹{fares.car}</h2>
        </div>
        ...
        <div onClick={() => {
          ...
          <div className='w-1/2 p-2'>
            ...
            <p className='font-medium text-sm text-gray-700'>Only for 3 people</p>
          </div>
          <h2 className='text-2xl font-semibold mr-6'>₹{fares.auto}</h2>
        </div>
        ...
        <div onClick={() => {
          ...
          <div className='w-1/2 p-2'>
            ...
            <p className='font-medium text-sm text-gray-700'>Motercycle, helmet available</p>
          </div>
          <h2 className='text-2xl font-semibold mr-6'>₹{fares.motorcycle}</h2>
        </div>
    </div>
  )
}
